          ...
          <TabsContent value="journeys" className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {journeys.map((journey) => {
                ...
                const filteredPrices = calculateFilteredPrices(
                  journey,
                  currentFilters
                );
                const displayPrices = Object.keys(currentFilters).some(
                            ...
                            <div className="flex flex-wrap gap-1">
                              {journey.carriers.map((carrier) => (
                                <Badge
                                  key={carrier}
                                  variant={
                                    currentFilters.selectedCarrier === carrier
                                      ? "default"
                                      : "outline"
                                  }
                                  ...
                                  onClick={() =>
                                    handleCarrierFilter(journey.id, carrier)
                                  }
                                >
                                  {carrier}
                                </Badge>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {journey.classes.map((travelClass) => (
                                <Badge
                                  ...
                                  onClick={() =>
                                    handleClassFilter(journey.id, travelClass)
                                  }
                                >
                                  {travelClass}
                                </Badge>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {journey.discountCards.slice(0, 3).map((card) => (
                                <Badge
                                  ...
                                  onClick={() =>
                                    handleDiscountCardFilter(journey.id, card)
                                  }
                                >
                                  {card}
                                </Badge>
                                ...
                                journey.offers.filter(
                                  (offer) =>
                                    (!currentFilters.selectedClass ||
                                      offer.travelClass ===
                                        currentFilters.selectedClass) &&
                                    (!currentFilters.selectedDiscountCard ||
                                      offer.discountCard ===
                                        currentFilters.selectedDiscountCard)
                                ).length
                              }{" "}
