...
export const useGlobalFilters = (journeys: GroupedJourney[]) => {
      ...
      .map((journey) => {
        const filteredOffers = journey.offers.filter((offer) => {
          ...
          if (
            ...
            !filters.selectedCarriers.includes(offer.carrier)
          ) {
            return false;
          }
          ...
          if (
            ...
            !filters.selectedClasses.includes(offer.travelClass)
          ) {
            return false;
          }
          ...
          if (
            ...
            !filters.selectedDiscountCards.includes(offer.discountCard)
          ) {
            return false;
          }
  ...
  const handleDiscountCardFilter = (
    ...
    setFilters((prev) => {
      ...
      console.log(
        "Nouvelle valeur des cartes de réduction exclues:",
